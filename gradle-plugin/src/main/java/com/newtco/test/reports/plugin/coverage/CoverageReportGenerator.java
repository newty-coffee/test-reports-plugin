...
import com.newtco.test.util.GitExecutor;
import com.newtco.test.util.JdepsDependencyCollector;
...
public class CoverageReportGenerator {
    ...
    private final CoverageReportExtension extension;
    ...
    public CoverageReportGenerator(TemplateInstantiator templateInstantiator, JacocoReport jacocoReport) {
        ...
        this.extension    = extensionOf(jacocoReport, CoverageReportExtension.class);
    ...
    private Set<File> getCoverageTargets() {
        ...
        var changeSetSpec = extension.getChangeSet().getAsSpec();
